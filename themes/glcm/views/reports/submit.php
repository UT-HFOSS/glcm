	...
	<div class="content-bg">
		...
		<div class="big-block">
			...
			<div class="report_left">
				...
				<div class="report_row">
					<h4><?php echo Kohana::lang('ui_main.reports_first'); ?><span class="required">*</span></h4>
				...
				<div class="report_row">
					<h4><?php echo Kohana::lang('ui_main.reports_email'); ?><span class="required">*</span></h4>
