...
$lang = array(
	'actions' => array(
		'add_to_category' => 'This adds the story to additional categories. If you select Category 1 here and the story already has Category 2 attached to it, the story will then have both Category 1 and Category 2.',
		'approve' => 'Approves a story or not. If approved, it will show up publicly.',
		...
		'category' => 'If you would like to activate triggers only when a certain category is being used, you can set that here. This will allow a trigger to be activated if only one of the categories is used. For instace, if you select Category 1 and Category 2 here and a story is shared using Category 2 and Category 3, it will pass the test.',
		...
		'location' => 'You can either select anywhere or a specific location. If you select a specific location, you will be asked to draw a box around the area that qualifies an action. For example, if you want this trigger to be activated when someone shares a story in Brazil, you will select "specific area" and then draw the box around Brazil. You can make these boxes as small or as large as you would like. You can also draw multiple boxes.',
		...
		'report_title' => 'This is the default title to add to the story.',
		'response' => 'If all of the qualifiers above are passed, the trigger will initiate a response. This can range from approving a story to emailing a user. Select the response here to activate additional options for the specific responses.',
		'send_to' => 'If you select "Triggering User", the email will be sent to the user who performed the action. If you select the radio button next to the input box, you will be able to enter a custom email address. This is useful if you are setting up triggers to notify people when certain parts of the map are seeing stories, check ins or some other activity.',
		...
		'trigger' => 'The trigger is the core component of setting up your Action Triggers. This is where you determine if you would like something to happen when someone shares a story, performs a check in, etc. You will be able to filter responses to these actions after selecting one.',
		...
		'verify' => 'Marks a story as verified or not.',
	) ,
	...
	'profile_notify' => 'Selecting YES lets you get alerts via email when new stories or comments are posted on your website.',
	...
	'profile_public' => 'Your profile can be viewed by anyone on the Internet if you check this option. This is also the easiest way to show off the stories you\'ve shared, your checkins, badges, etc all on one page.',
	...
	'settings_allow_clustering' => 'This allows bundling of similar stories into a single dot on the map',
	'settings_allow_comments' => 'Allow users to comment on stories on the main site.',
	...
	'settings_display_items_per_page' => 'This is the number of stories displayed per page on the main site.',
	'settings_display_items_per_page_admin' => 'This is the number of stories displayed per page on the admin Back End.',
	...
	'settings_map_timeline' => 'This shows the timeline based on the date and time stories were shared',
	...
	'settings_server_password' => 'This is the password for the email address that receives stories.',
	...
	'settings_server_username' => 'This is the email address that receives stories.',
	...
	'settings_site_submit_report_message' => 'This is a message that will show up on the share a story page. This is good for disclaimers or further instructions for your visitors who are reporting.',
	'settings_site_tagline' => 'In a few words, explain what this site is about.',
	'settings_site_timezone' => 'This is the timezone that your site will operate on. This has an impact on any actions you have set up that utilize time and date, as well as the default current time for stories on the front and back end of the site.',
