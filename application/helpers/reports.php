...
class reports_Core {
	...
	public static function validate(array & $post)
	{
		...
		$post->add_rules('incident_photo', 'upload::valid', 'upload::type[gif,jpg,png,jpeg]', 'upload::size[5M]');

		// Validate Personal Information
		$post->add_rules('person_first', 'required', 'length[2,100]');
		$post->add_rules('person_email', 'email', 'required', 'length[3,100]');
